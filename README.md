...
Owns shipmentsdb. Shipment lifecycle state machine. Sole producer of shipment.* events.
...
```bash
npm ci
npm run dev        # tsx watch, listens on 3002
...
`ghcr.io/echelon-luxe/logitrack-shipment-service:<git-sha>`.
